...
class Exp_Informer(Exp_Basic):
    ...
    def predict(self, 
                setting, load=False,
                mlflow_load=False, model_encoder_uri=None, 
                model_prediction_uri=None, experiment_name=None
            ):
        ...
        pred_data, pred_loader = self._get_data(flag='pred',setting=setting)#, encoder=encoder, scaler=scaler)
