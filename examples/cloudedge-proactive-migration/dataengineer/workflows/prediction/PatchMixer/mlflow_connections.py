...
class MLflowConnections:
    ...
    def get_uri(self):
        """
        Returns a list of the URIs for the models. Useful so they can be loaded and used for prediction later.
        """
        # Initialize MLflow client
        mlflow_client = MlflowClient(self.mlflow_uri)
        ...
        for model in self.models_to_download:
            ...
            if mv is None:
                ...
                uri=mlflow_client.get_model_version_download_uri(model,mv[0].version)
