    ...
    def initialize_training(self):
        ...
        for cluster_id in self._data[self.clusters].unique():
            ...
            with mlflow.start_run(run_name=f"Cluster_{cluster_id}") as run:
                ...
                mlflow.sklearn.log_model(scaler_x, artifact_path=f"LSTM_scaler_x_{cluster_id}.joblib", registered_model_name=f"LSTM_scaler_x_{cluster_id}")
                mlflow.sklearn.log_model(scaler_y, artifact_path=f"LSTM_scaler_y_{cluster_id}.joblib", registered_model_name=f"LSTM_scaler_y_{cluster_id}")
